...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/send-department-form/{tableName}', [FormsController::class, 'departmentStoreForm'])->name('dashboard.department_store_form')->middleware('check.data.entry');
    ...
    Route::post('/send-employee-form/{tableName}', [FormsController::class, 'employeeStoreForm'])->name('dashboard.employee_store_form')->middleware('check.data.entry');
