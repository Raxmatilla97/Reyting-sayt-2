...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('point_user_deportaments', function (Blueprint $table) {
            ...
            $table->foreign('table_1_3_1_a_id')->references('id')->on('table_4_')->onDelete('cascade');
            $table->foreign('table_1_3_1_b_id')->references('id')->on('table_5_')->onDelete('cascade');
            $table->foreign('table_1_3_2_a_id')->references('id')->on('table_6_')->onDelete('cascade');
            $table->foreign('table_1_3_2_b_id')->references('id')->on('table_7_')->onDelete('cascade');
        });
    }
