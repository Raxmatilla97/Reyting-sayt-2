...
class Table_11_3_DataCode
{
    public function exportTableData($sheet, $pointUserDeportaments)
    {
        ...
        foreach ($pointUserDeportaments as $pointEntry) {
            $table_11_3_record = $pointEntry->table_11_3; // Tablitsiya relation to'g'ri formatda
            ...
            if ($table_11_3_record) {
                try {
                    ...
                    $sheet->setCellValue('D' . $row, $table_11_3_record->jurnal_nomi ?? 'N/A');
                    $sheet->setCellValue('E' . $row, $table_11_3_record->nashr_yili ?? 'N/A');
                    $sheet->setCellValue('F' . $row, $table_11_3_record->maqola_nomi ?? 'N/A');
                    $sheet->setCellValue('G' . $row, $table_11_3_record->tili ?? 'N/A');
                    $sheet->setCellValue('H' . $row, $table_11_3_record->index_url ?? 'N/A');
                    $sheet->setCellValue('I' . $row, $table_11_3_record->iqtiboslar_soni ?? 'N/A');
