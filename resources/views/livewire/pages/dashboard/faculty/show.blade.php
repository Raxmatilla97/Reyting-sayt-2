                                ...
                                <div class="container mx-auto mt-5">
                                    <div class="border-b border-gray-200 dark:border-gray-700">
                                        <ul
                                            ...
                                            <li class="me-2">
                                                <a href="#yuborilgan_malumotlar"
                                                    class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg tab"
                                                    data-tab="yuborilgan_malumotlar">
                                                    <svg class="w-4 h-4 me-2 text-gray-400" aria-hidden="true"
                                                        xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                        viewBox="0 0 20 20">
                                                        <path
                                    ...
                                    <div id="tab-content">
                                        ...
                                        <div id="department_list" class="tab-content hidden">
                                            ...
                                            <div id="yuborilgan_malumotlar" class="tab-content hidden">
                                    ...
                                    <script>
                                        document.addEventListener('DOMContentLoaded', () => {
                                            ...
                                            // Show default tab
                                            showTab(document.querySelector('.tab.active') || tabs[0]);
                                        });
                                    </script>
                                    {{--  --}}
                                </div>
