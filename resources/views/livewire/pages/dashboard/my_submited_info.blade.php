<x-app-layout>
    ...
    <div class="py-12">
        ...
        @foreach ($pointUserInformations as $info)
    <div>
        <p>Information ID: {{ $info->id }}</p>
        @foreach ($tableFields as $field)
            @if (isset($relatedData[$info->id][$field]))
                <p>Related data for {{ $field }}: {{ json_encode($relatedData[$info->id][$field]) }}</p>
            @endif
        @endforeach
    </div>
@endforeach
                                            ...
                                            <tr
                                                ...
                                                <th scope="row"
                                                    ...
                                                    <img class="hidden sm:block w-10 h-10 rounded-full"
                                                        style="object-fit: cover;" src="{{'/storage/users/image'}}/{{auth()->user()->image}}"
                                                        alt="">
