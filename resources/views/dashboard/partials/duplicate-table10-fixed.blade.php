<!-- Table 10 tuzatilgan dublikatlari -->
...
<div class="bg-white overflow-hidden shadow-lg sm:rounded-lg mb-6 border border-green-300">
    <div class="p-6 bg-gradient-to-r from-green-50 to-green-100 border-b border-green-200">
        <h3 class="text-lg font-bold text-green-900 mb-4">
            ...
            Table 10 tuzatilgan dublikatlari ({{ count($table10FixedDuplicates) }} ta)
        </h3>
        
        @foreach($table10FixedDuplicates as $fixed)
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="bg-green-100 border-l-4 border-green-600 p-3 rounded shadow">
                            ...
                            <div class="text-xs text-gray-700 space-y-1">
                                <p><strong>Jurnal/Konferensiya:</strong> {{ Str::limit($record['jurnal_nomi'], 40) }}</p>
                                <p><strong>Maqola:</strong> {{ Str::limit($record['maqola_nomi'], 40) }}</p>
                                <p><strong>Nashr yili:</strong> {{ $record['nashr_yili'] }}</p>
                                <div class="mt-2">
...
<div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
    <div class="flex items-center">
        ...
        <span class="text-blue-800">Table 10 da hali tuzatilgan dublikatlar yo'q.</span>
    </div>
</div>
@endif 