                    ...
                    <div x-data="{ activeTab: 'about_us' }" class="container mx-auto">
                        ...
                        <div class="hidden sm:block mb-6">
                            <nav class="flex space-x-4" aria-label="Tabs">
                                <button @click="activeTab = 'about_us'" :class="{'bg-indigo-100 text-indigo-700': activeTab === 'about_us'}" class="px-3 py-2 font-medium text-sm rounded-md">Kafedra haqida</button>
                                <button @click="activeTab = 'department_list'" :class="{'bg-indigo-100 text-indigo-700': activeTab === 'department_list'}" class="px-3 py-2 font-medium text-sm rounded-md">O'qituvchilar ro'yxati</button>
                                <button @click="activeTab = 'yuborilgan'" :class="{'bg-indigo-100 text-indigo-700': activeTab === 'yuborilgan'}" class="px-3 py-2 font-medium text-sm rounded-md">Yuborilgan ma'lumotlar</button>
                            </nav>
                        </div>
                        ...
                        <div class="mt-8">
                                ...
                                <div class="overflow-x-auto bg-white rounded-lg shadow">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        <thead class="bg-gray-50">
                                            <tr>
                                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">O'qituvchi F.I.SH</th>
                                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Yuborilgan ma'lumotlar soni</th>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="flex items-center">
                                                            <div class="flex-shrink-0 h-10 w-10">
                                                                <span class="inline-flex items-center justify-center h-10 w-10 rounded-full bg-indigo-100 text-indigo-800 font-medium text-lg">
                                                                    {{ substr($employee->FullName, 0, 2) }}
                                                                </span>
                                                            </div>
                                                            <div class="ml-4">
                                                                <a href="{{ route('dashboard.employeeShow', ['id_employee' => $employee->employee_id_number]) }}" class="text-sm font-medium text-gray-900 hover:text-indigo-600">
                            ...
                            <div x-show="activeTab === 'yuborilgan'" class="space-y-6">
                                <h3 class="text-2xl font-bold text-gray-900 mb-6">Kafedra o'qituvchilari tomonidan yuborilgan ma'lumotlar</h3>
                                <div class="bg-white overflow-hidden shadow-lg rounded-lg">
