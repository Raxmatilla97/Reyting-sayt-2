            ...
            <div class="modal-header flex items-center justify-between p-6 border-b">
                ...
                <div class="flex items-center gap-2">
                    <div id="edit-button-container" style="display: none;">
                        <a href="#" id="edit-link"
                            class="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-4 py-2 flex items-center gap-2">
