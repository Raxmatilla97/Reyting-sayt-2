        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Yangi KPI Mezoni</h2>

                    <form action="{{ route('admin.criteria.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" required
                                      class="mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="max_points" name="max_points" required
                                   value="{{ old('max_points') }}" step="0.1" min="0"
                                   class="mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="calculation_method" name="calculation_method" rows="3" required
                                      class="mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('calculation_method') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="evaluation_period" name="evaluation_period" required
                                   value="{{ old('evaluation_period', 'bir yil') }}"
                                   class="mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="required_proof" name="required_proof" rows="2"
                                      class="mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('required_proof') }}</textarea>
                        </div>
