                                        ...
                                        <div class="bg-white  rounded-lg p-6">
                                            <table class="w-full table-auto">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="border-b">
                                                        <td class="px-4 py-4">
                                                            <span class="inline-flex items-center justify-center w-5 h-5 me-2 text-md font-semibold text-blue-800 bg-blue-100 rounded-full dark:bg-gray-700 dark:text-blue-400">
                                                            ...
                                                            <span class="bg-blue-100 text-blue-800 text-md font-medium px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">
                                                                <a href="{{ route('dashboard.departmentShow', ['slug' => $department->slug]) }}">{{ $department->name }}</a>
                                                            </span>
                                                        </td>
                                                        <td class="px-4 py-2 text-center">
                                                        ...
                                                        <td class="px-4 py-2 text-center">
                                                            @php
                                                                $point_full = $department->point_user_deportaments
                                                                    ->where('status', 1)
                                                                    ->sum('point');
                                                            @endphp
                                                            {{ $point_full }}
