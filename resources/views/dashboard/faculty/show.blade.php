                ...
                <div class="p-6 bg-white">
                    <div x-data="{ activeTab: 'yuborilgan' }" class="container mx-auto">
                        ...
                        <div class="mt-8" x-cloak>
                            ...
                            <div x-show="activeTab === 'about_us'" x-transition:enter="transition ease-out duration-300"
                                ...
                                <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                                    <div class="flex flex-col lg:flex-row">
                                        ...
                                        <div class="lg:w-1/3 p-8 bg-gradient-to-br from-blue-600 to-indigo-600 text-white">
                                            <div class="flex flex-col items-center justify-center h-full space-y-4">
                                                <div class="relative">
                                                    <div class="absolute inset-0 bg-white rounded-full opacity-10 animate-pulse">
                                                    </div>
                                                ...
                                                <div class="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                                    <div class="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="bg-blue-100 text-blue-800 text-lg font-medium px-2.5 py-0.5 rounded">
                                                                {{ $totalEmployees }} nafar
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                                    <div class="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="bg-yellow-100 text-yellow-800 text-lg font-medium px-2.5 py-0.5 rounded">
                                                                {{ $totalInfos }} ta
                                                            </span>
                                                        </div>
                                                    </div>
                           ...
                           <!-- Department List Tab -->
                           <div x-show="activeTab === 'department_list'" x-transition:enter="transition ease-out duration-300"
                           x-transition:enter-start="opacity-0 transform translate-x-4"
                           x-transition:enter-end="opacity-100 transform translate-x-0">
                                           ...
                                           @php
                                               ...
                                               foreach ($departmentCounts as $facultyDepartments) {
                                                   if (isset($facultyDepartments[$department->id])) {
                                                       $configTeacherCount = $facultyDepartments[$department->id];
                                                       break;
                                                   }
                                               }

                                               $departmentPointTotal = 0;
                                               foreach ($department->point_user_deportaments->where('status', 1) as $pointEntry) {
                                               ...
                                               $averagePoints = $configTeacherCount > 0 ? round($departmentPointTotal / $configTeacherCount, 2) : 'N/A';
                                           @endphp
                       ...
                       <!-- Yuborilgan Tab -->
                       <div x-show="activeTab === 'yuborilgan'" x-transition:enter="transition ease-out duration-300"
                           x-transition:enter-start="opacity-0 transform translate-x-4"
                           x-transition:enter-end="opacity-100 transform translate-x-0">
                           <div class="space-y-6">
