                    ...
                    <div class="mb-8">
                        <div x-data="{ activeTab: 'about_us' }" class="container mx-auto">
                            ...
                            <div class="sm:hidden mb-6">
                                <select x-model="activeTab" class="block w-full px-4 py-3 text-base bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            ...
                            <div class="hidden sm:block border-b border-gray-200 mb-8">
                                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                                    <a href="#" @click.prevent="activeTab = 'about_us'" :class="{ 'border-indigo-500 text-indigo-600': activeTab === 'about_us' }" class="border-transparent text-gray-600 hover:text-gray-800 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-lg">
                                        Fakultet haqida
                                    </a>
                                    <a href="#" @click.prevent="activeTab = 'department_list'" :class="{ 'border-indigo-500 text-indigo-600': activeTab === 'department_list' }" class="border-transparent text-gray-600 hover:text-gray-800 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-lg">
                                        Fakultet kafedralari
                                    </a>
                                    <a href="#" @click.prevent="activeTab = 'yuborilgan'" :class="{ 'border-indigo-500 text-indigo-600': activeTab === 'yuborilgan' }" class="border-transparent text-gray-600 hover:text-gray-800 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-lg">
                            ...
                            <div class="mt-6">
                                <div x-show="activeTab === 'about_us'" class="space-y-6">
                                    ...
                                    <div class="flex flex-col sm:flex-row items-center bg-gray-50 rounded-lg p-6 shadow-sm">
                                        <div class="w-full sm:w-1/3 flex justify-center mb-6 sm:mb-0">
                                            <img src="https://cdn1.iconfinder.com/data/icons/got-idea-vol-2/128/branches-1024.png" alt="Logo" class="w-40 h-40 object-cover rounded-full border-4 border-indigo-300">
                                        </div>
                                        <div class="w-full sm:w-2/3 sm:pl-8">
                                            <h1 class="text-3xl sm:text-4xl font-bold text-indigo-700 mb-4">{{ $faculty->name }}</h1>
                                            ...
                                            <ul class="space-y-3 text-lg text-gray-600">
                                                <li><span class="font-semibold">Fakultet o'qituvchilar soni:</span> {{ $totalEmployees }} nafar</li>
                                                <li><span class="font-semibold">Fakultet to'plangan umumiy ballar:</span> {{ $totalPoints }}</li>
                                                <li><span class="font-semibold">Fakultet hisobidagi yuborilgan ma'lumotlar soni:</span> {{ $totalInfos }} ta</li>
                                                <li><span class="font-semibold">Oxirgi yuborilgan ma'lumot vaqti:</span> {{ $timeAgo }}</li>
                                                <li><span class="font-semibold">Oxirgi yuborgan ma'lumot egasi nomi:</span> {{ $fullName }}</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="flex items-center">
                                                            <div class="flex-shrink-0 h-12 w-12">
                                                                <span class="inline-flex items-center justify-center h-12 w-12 rounded-full bg-indigo-100">
                                                                    <span class="text-xl font-medium text-indigo-800">{{ substr($department->name, 0, 2) }}</span>
                                                                </span>
                                                            </div>
                                                            <div class="ml-4">
                                                                <a href="{{ route('dashboard.departmentShow', ['slug' => $department->slug]) }}" class="text-lg font-medium text-gray-900 hover:text-indigo-600">{{ $department->name }}</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                ...
                                <div x-show="activeTab === 'yuborilgan'" class="space-y-6">
                                    <h3 class="text-2xl font-bold text-gray-900 mb-6">Fakultet o'qituvchilari tomonidan yuborilgan ma'lumotlar</h3>
