<x-guest-layout>
    ...
    @if ($errors->any())
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 pb-4 py-3 rounded relative" role="alert">
    ...
    <form method="POST" action="{{ route('login') }}" class="mt-4">
        ...
        <div class="flex justify-center mt-3">
            <a href="{{ route('redirectToAuthorization') }}"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-center text-2xl">
                HEMIS orqali kirish
            </a>
        </div>
